...
# Use a suitable backend for desktop environments
...
# Function to extract Gabor texture features
...
def extract_features(image_path):
    ...
    brightness_feat = np.array([brightness(image)])
    
    features = np.concatenate([color_hist, gabor_feat, edge_feat, brightness_feat])
    
    print(f"Extracted feature size: {features.shape}")  # Print the size of the extracted features
    return features
...
def main():
    ...
    distance_threshold = 4  # Set your distance threshold here
